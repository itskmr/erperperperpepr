...
exports.getAllTeachers = async (req, res) => {
  try {
    ...
    const formattedTeachers = teachers.map(teacher => ({
      ...
      profileImage: teacher.profileImage || 'https://placehold.co/150x150/e2e8f0/475569?text=No+Image',
...
exports.updateTeacher = async (req, res) => {
  try {
    ...
    const formattedTeacher = {
      ...
      profileImage: updatedTeacher.profileImage || 'https://placehold.co/150x150/e2e8f0/475569?text=No+Image',
