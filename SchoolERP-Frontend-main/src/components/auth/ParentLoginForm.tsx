  ...
  const moveToNextStep = async (): Promise<void> => {
    ...
    if (currentStep === 'invitation') {
      ...
      try {
        ...
        const response = await fetch('/api/auth/parent/validate-invitation', {
          method: 'POST',
          headers: {
    ...
    <div className="parent-login-container">
      ...
      >
        ...
        <p className="text-xs text-pink-700 mt-1">
          ...
          {currentStep === 'admission' && 'Enter your child\'s admission number to link your account to your child\'s profile.'}
