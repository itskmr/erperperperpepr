  ...
  const printContent = `
    ...
    <body>
        <div class="admission-form-container">
            ${generateSchoolHeader(schoolInfo, 'Admission Form')}
            ...
            <!-- PAGE 2 HEADER -->
            ${generateSchoolHeader(schoolInfo, 'Admission Form (Page 2)')}
            ...
            <table style="margin-bottom: 15px;">
                <tr>
                    <td style="width: 33%; text-align: center; padding: 8px;">
                        ...
                        <div style="margin-top: 8px; font-size: 8px; text-align: center; border-bottom: 1px solid #999; height: 20px;">
                            Signature
                        </div>
                    </td>
                    <td style="width: 33%; text-align: center; padding: 8px;">
            ...
            <table class="compact-table" style="border: 2px solid #333;">
                <tr style="background: #f0f0f0;">
                    <th style="border: 1px solid #333; padding: 4px; font-size: 8px; width: 20%;">Details</th>
                    <th style="border: 1px solid #333; padding: 4px; font-size: 8px; width: 25%;">Mother</th>
                    <th style="border: 1px solid #333; padding: 4px; font-size: 8px; width: 25%;">Father</th>
                    <th style="border: 1px solid #333; padding: 4px; font-size: 8px; width: 30%;">Local Guardian<br>(If required)</th>
                </tr>
                <tr>
                    <td style="border: 1px solid #333; padding: 4px; font-size: 8px; font-weight: bold; height: 18px;">Full Name</td>
