...
const SchoolLogin: React.FC = () => {
  ...
  // Demo account for school
  const demoAccount = { email: 'Ram2@gmail.com', password: 'Ram@1234' };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (useDemo || (formData.email === demoAccount.email && formData.password === demoAccount.password)) {
        ...
        // Store auth token
        const mockToken = `school-token-${Date.now()}`;
        const mockUserData = {
          id: 1,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-4">
      <div className="w-full max-w-md">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">School Login</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300"
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-xs text-blue-800 font-semibold">Demo School Credentials</p>
